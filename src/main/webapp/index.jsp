...
<body>
	...
	<h1 style="color: maroon; font-size: 60px;" align="center">this is ci/cd automation</h1>
	<h1 style="color: maroon; font-size: 40px;" align="center">this is ci/cd automation</h1>	
</body>
</html>
